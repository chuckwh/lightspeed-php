		...
		<div class="col-md-12">
			<?=$this->form->create($photo, array('type' => 'file', 'class' => 'photo-form ml15', 'id' => 'photo_form', 'name' => 'photo_form'));?>
				...
				?>
					...
					<?=$this->form->field('title', array('id'=>'title', 'class' => 'form-control', 'template' => '<div {:wrap}>{:label}<div class="help">Choose a title for your thoughts to make them easier to find</div>{:input}{:error}</div>')); ?>
					<?=$this->form->field('Say Something', array('type'=>'textarea', id=>"status", 'class'=>'form-control',  'rows'=> '6', 'template' => '<div {:wrap}>{:label}<div class="help">Add your thoughts</div>{:input}{:error}</div>')); ?>
					<div class="mt10 help">
				    ...
				    <?=$this->form->field('credit', array('id'=>'credit', 'class' => 'form-control', 'template' => '<div class="mt10" {:wrap}>{:label}<div class="help">Photo not yours? PLEASE provide a credit or URL</div>{:input}{:error}</div>')); ?>
					<div id="progress_bar">
					...
					<div class="mt10">
						<?=$this->form->submit('Save', array( 'id'=> 'do_post',
								'data-secure-url' => '',
								'data-public-id' => '',
								'data-version' => '',
								'data-format' => '',
