<?php $this->title('Mixer Top-pics: CreateAMixer'); ?>
<?php
$data = null;
$counter = 0;
$picNumber = rand(1, 4);
				...
				<div class="topix">
					...
					<div class="topix-img">
						...
						<?php if($photo->public_id != null) {?>
								<?php echo $this->html->image(CLOUDINARY_BASE_URL . "/image/upload/w_150/v{$photo->version}/{$photo->public_id}.{$photo->format}", array('width'=> 150, 'id' => 'i_' . $photo->_id)); ?>
						<?php }
							else {?>
								<?php echo $this->html->image(CLOUDINARY_BASE_URL . "/image/upload/w_150/" . $defaultImage, array('width'=> 150)); ?>
							<?php }?>
						</a>
					</div>
