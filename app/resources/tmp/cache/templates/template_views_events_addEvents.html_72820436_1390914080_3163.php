...
<div class="row" id="boss">
	<div class="col-md-12">
		<div class="container">
			<?php echo $this->form->create(null, array('url' => '/events/addEvent', 'name' => 'create_event_form', 'id' => 'create_event_form', 'role' => 'form', 'class' => 'form-horizontal table-style')); // Echoes a <form> tag .; ?>
			 <?php echo $this->form->field(array('name' => 'Enter Your Name'), array(
			 	'id' => 'name', 
			 	'class' => 'input-lg', 
			 	'tabindex'=>'1',  
			 	'required' => 'required',
			 ...
			 <?php echo $this->form->field(array('location' => 'Enter Your Postal Code'), array(
			 	'id' => 'location', 
			 	'class' => 'input-lg', 
			 	'tabindex'=>'2',  
			 	'required' => 'required',
			 ...
			 <?php echo $this->form->field(array('date' => 'Enter Date For Your Event'), array(
			 	'id' => 'date', 
			 	'class' => 'input-lg', 
			 	'tabindex'=>'3',  
			 	'required' => 'required',
				...
				<?php echo $this->form->hidden('hostid', array(
					'id' => 'hostid', 
					'tabindex'=>'-1',
					'value' => $userSession['id'])); ?>

			<?php echo $this->form->submit('Create Event', array(
				'id' => 'submit_event',
				'tabindex'=>'4',
				 'name' => 'submit_event', 
				 'class' => 'btn btn-large btn-primary') ); ?>
			<?php echo $this->form->end(); // Echoes a </form> tag & unbinds the form; ?>
			<div id="addSMS">
		        ...
		        <?php echo $this->form->create(null, array('url' => '/events/sendSMS','name' => 'phone_form', 'id' => 'phone_form')); ?>
		        <?php //request token functionality provided through the lithium PHP framework ?>
		    	<?php echo $this->security->requestToken(array('name'=>'cm-token', 'id'=>'cm-token')); ?>
				...
				<?php echo $this->form->submit('Send SMS', array('class' => 'btn btn-primary mt10', 'id' => 'send_phone')); ?>
