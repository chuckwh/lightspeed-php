...
?>
<!doctype html>
<?php echo $this->ieconditionals->conditionals(); ?>
<head>
<!-- layout photos -->
 <?php
...
?>
 	<?php echo $this->fontscript->fontscript(); ?>
	<?php echo $this->metatags->metatags(FALSE, FALSE); ?>
...
<body data-layout="photos">
	...
	<div class="row">
		...
		<div id="login-logout" class="col-md-8">
			<?php echo $this->nav->nav($userSession['username'], 'default'); ?>
		</div>
		<div class="col-md-2"></div>
	</div>
...
<?php echo $this->html->script(array(
	...
	<script type="text/javascript">
	 $.cloudinary.config({'api_key':'<?php echo $h(CLOUDINARY_API_KEY); ?>','cloud_name':'<?php echo $h(CLOUDINARY_CLOUD_NAME); ?>'});
	</script>
